      ...
      <div className="section-container flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1 order-2 md:order-1 max-w-xl mx-auto text-center reveal-left">
          ...
          <div className="flex flex-wrap gap-4 button-spacing justify-center">
            ...
            <Button asChild variant="outline" className="border-blue-500/50 text-blue-400 hover:bg-blue-500/10 backdrop-blur-sm bg-blue-500/5">
              <a href="#projects">View Projects</a>
            </Button>
            
            <Button asChild variant="secondary" className="bg-gradient-to-r from-cyan-600/80 to-blue-600/80 hover:from-cyan-700 hover:to-blue-700 text-white shadow-lg">
          ...
          <div className="flex gap-4 mt-8 justify-center">
            ...
            <a href="mailto:arjunguptain@outlook.com" className="w-12 h-12 rounded-full flex items-center justify-center bg-secondary/50 backdrop-blur-sm hover:bg-blue-500/20 text-muted-foreground hover:text-blue-400 transition-all border border-blue-500/20 hover:border-blue-500/40" aria-label="Email">
              <Mail size={22} />
            </a>
          </div>
        </div>
