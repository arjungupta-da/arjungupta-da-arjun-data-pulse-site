        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex flex-col md:flex-row justify-between mb-4">
              <div>
                <h3 className="text-2xl font-display font-bold text-primary">Bachelors of Science in Physical Sciences with Computer Science</h3>
          ...
          >
            <div className="flex flex-col md:flex-row justify-between mb-4">
              <div>
                <h3 className="text-2xl font-display font-bold text-primary">Non-Medical Science with Computer Science</h3>
