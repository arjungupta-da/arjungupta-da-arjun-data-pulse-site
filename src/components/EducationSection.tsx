        ...
        <div className="space-y-8">
          <div className="glass-card p-8 rounded-lg">
            <div className="flex flex-col md:flex-row justify-between mb-4">
              <div>
                <h3 className="text-2xl font-display font-bold text-orange-400">Bachelors of Science in Physical Sciences with Computer Science</h3>
          ...
          <div className="glass-card p-8 rounded-lg">
            <div className="flex flex-col md:flex-row justify-between mb-4">
              <div>
                <h3 className="text-2xl font-display font-bold text-orange-400">Non-Medical Science with Computer Science</h3>
